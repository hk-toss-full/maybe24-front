...
const RankingItem = (props: RankingItemProps) => {
  ...
  return (
    <div className="h-80 w-92 group cursor-pointer flex-1">
      <div className="relative h-full ">
        ...
        <div className="h-full w-full overflow-hidden">
          <img
            ...
            className="w-full blur-sm object-cover group-hover:scale-110 transition-all duration-300"
          />
        </div>
        <img
          src={thumbnail}
        ...
        />
        <div className="absolute -bottom-3 left-4 w-12 h-12 z-30 bg-[#ec7d2c] text-white flex justify-center items-center">
          {order}위
        </div>
      </div>
